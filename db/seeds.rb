...
Curso.create(nombre: 'resortes',
            ...
            descripcion: """(fortalecimiento???,
              url_direccion: "")Músculos y huesos se benefician con la práctica de resortes. Además de sus bondades fisioterapéuticas, estos ejercicios tonifican y definen los músculos. Según la orientación del trabajo, se puede optar por aumentar o no la masa muscular.""",
            lugar: 's_tono',
            url_direccion: "")
